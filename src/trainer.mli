...
(** Creates a new Trainer with name [name], available camls [caml_list], active
    caml [active_pcaml], and declares if the trainer is playable (meaning if its
    an not an ai) [playable] *)
